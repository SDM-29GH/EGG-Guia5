...
package guia5_ejercicio11;

import java.util.Locale;
import java.util.Scanner;

public class eje__11 {

    public static void main(String[] args) {
        Scanner leer = new Scanner(System.in, "ISO-8859-1").useDelimiter("\n").useLocale(Locale.US);

        System.out.println("Indique el tipo de bomba o tipo de motor");
        ...
        switch (bomba) {
            ...
            case 4:
                ...
                break;
            default:
                System.out.println("No existe un valor valido para tipo de bomba. Numero incorrecto");
        }
    }
}
